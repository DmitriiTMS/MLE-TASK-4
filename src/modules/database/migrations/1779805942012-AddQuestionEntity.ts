...
export class AddQuestionEntity1779805942012 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "questions" ("id" SERIAL NOT NULL, "poll_id" integer NOT NULL, "text" text NOT NULL, "type" character varying(20) NOT NULL, "order_num" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_08a6d4b0f49ff300bf3a0ca60ac" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "questions" ADD CONSTRAINT "FK_4d1a4db0bc11abc1a80a167935c" FOREIGN KEY ("poll_id") REFERENCES "polls"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
