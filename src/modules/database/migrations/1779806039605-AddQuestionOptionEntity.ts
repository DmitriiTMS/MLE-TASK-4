...
export class AddQuestionOptionEntity1779806039605 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "question_options" ("id" SERIAL NOT NULL, "question_id" integer NOT NULL, "text" character varying(255) NOT NULL, "order_num" integer NOT NULL, CONSTRAINT "PK_13be20e51c0738def32f00cf7d5" PRIMARY KEY ("id"))`);
